    ...
    <>
      <div className="w-[90%] mx-auto">
        ...
        <div className="hidden lg:block">
          <div className="flex-wrap justify-center w-full pt-[45px] flex">
            <div className="w-[25%]">
        ...
        <div className="md:block lg:hidden hidden">
          ...
          <div className="flex-wrap justify-around w-[65%] mx-auto pt-[45px] flex">
            <div className="w-[25%]">
              <div className="flex justify-center">
                <Image src={img1} alt="" />
              </div>
        ...
        <div className="block md:hidden">
          ...
          </div> <div className="flex-wrap justify-around w-[100%] mx-auto pt-[45px] flex">
            <div className="w-[25%]">
              <div className="flex justify-center">
                <Image src={img1} alt="" />
              </div>
